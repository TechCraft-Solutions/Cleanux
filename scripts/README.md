...
This directory contains utility scripts for the Cleanux project.

## Build Scripts

### `build-optimized.sh` (Linux/macOS) and `build-optimized.cmd` (Windows)

These scripts provide optimized builds for the Cleanux application, helping avoid unnecessary recompilation of components.
...
- `flatpak/com.tcs.cleanux.yml` (Flatpak manifest)
- `flatpak/com.tcs.cleanux.metainfo.xml` (App metadata)
