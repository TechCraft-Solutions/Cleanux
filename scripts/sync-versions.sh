...
if [ -f "flatpak/com.tcs.cleanux.yml" ]; then
  sed -i "s/^version: .*/version: '$NEW_VERSION'/" flatpak/com.tcs.cleanux.yml
  echo "✓ Updated flatpak/com.tcs.cleanux.yml"
fi
...
# Update metainfo for cleanux
if [ -f "flatpak/com.tcs.cleanux.metainfo.xml" ]; then
  update_metainfo "flatpak/com.tcs.cleanux.metainfo.xml"
fi
